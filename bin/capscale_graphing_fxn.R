#This is a mapping function taken from Isai. It is from his ohchibi package in R

create_figure_from_caps_data <- function(list_ohpco=NULL,col_val=NULL,shape_val=NULL,comp_a=NULL,comp_b=NULL,mypch=10,
                                         size=10,alpha=0.9,stroke=1.5,col_shape_background="white",alpha_shape_background=0,
                                         lines_zero = FALSE,size_axis_line = 0.5,type_axis_line = "longdash",
                                         ratio_size_shape_background=1,y_vjust=0.5,x_hjust=0.5,size_axis_text=20,size_axis_title=30,
